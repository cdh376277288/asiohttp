...
//https://www.baidu.com
//////////////////////////////////////////////////////////////////////////
int cdh::HttpBase::parseUrl(const std::string& url, std::string& out_server, std::string& out_port, std::string& out_path)
{
...
int cdh::HttpBase::buildPostRequest(const std::string& server, const std::string& path, std::ostream& out_request)
{
	// 分割path中的json数据
...
int cdh::HttpBase::buildGetRequest(const std::string& server, const std::string& path, std::ostream& out_request)
{
